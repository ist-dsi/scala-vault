...
import pt.tecnico.dsi.vault.{Service, TokenType}
...
/**
  ...
  * @param policies list of policies set on tokens issued via this AppRole.
  ...
  * @param period Duration in either an integer number of seconds (3600) or an integer time unit (60m). If set, the token
